...
#Preview {
    BiographySectionView(
        actor: ActorDetails(
            ...
            deathday: Calendar.current.date(
                            from: DateComponents(
                                year: 2025,
                                month: 5,
                                day: 20
            ...
            biography: "Robert De Niro is an American actor and producer. Robert De Niro is an American actor and producer. Robert De Niro is an American actor and producer. Robert De Niro is an American actor and producer.",
            profilePath: nil,
            profileURL: nil,
            homepage: nil,
            imdbID: "nm0000134",
            alsoKnownAs: ["Bobby De Niro"]
        ),
        profileImageURL: URL(
            string: "https://image.tmdb.org/t/p/w780/cT8htcckIuyI1Lqwt1CvD02ynTh.jpg"
        ),
        externalLinks: [],
        isFavourite: false,
