...
extension MovieDetailsViewModel {
    ...
    private func load(force: Bool) async {
        ...
        async let historyTask: Void = recordRecentlyViewed(movie)
    ...
    private func recordRecentlyViewed(_ movie: Movie) async {
        do {
            try await addRecentlyViewedMovieUseCase.execute(
                RecentlyViewedMovie(
                    id: movie.id,
                    title: movie.title,
