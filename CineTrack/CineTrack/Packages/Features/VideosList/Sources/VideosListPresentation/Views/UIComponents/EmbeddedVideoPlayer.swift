...
struct EmbeddedVideoPlayer: UIViewRepresentable {
    ...
    final class Coordinator: NSObject, WKScriptMessageHandler {
        ...
        func userContentController(
            ...
            DispatchQueue.main.async {
                if let code = state["error"] as? NSNumber {
                    ...
                    self.playbackError.wrappedValue = "This video couldn't be played here. Try opening it on YouTube. (\(code.intValue))"
                    return
                }
        ...
        private var unavailableVideoHTML: String {
            "<html><body style='margin:0;background:#000;color:#fff;display:flex;align-items:center;justify-content:center;font-family:-apple-system'>Video unavailable</body></html>"
        }
    }
}
