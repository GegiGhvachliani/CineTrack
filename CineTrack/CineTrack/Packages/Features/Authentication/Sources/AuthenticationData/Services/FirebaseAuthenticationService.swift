...
public final class FirebaseAuthenticationService: AuthenticationServiceProtocol {
    ...
    public func signUpWithEmail(email: String, username: String, password: String) async throws
        -> AuthenticationDomain.User {
        do {
                ...
                throw NSError(
                    ...
                    userInfo: [
                        NSLocalizedDescriptionKey:
                            "Unable to find root view controller for Google Sign-In presentation."
                    ]
                )
            }
