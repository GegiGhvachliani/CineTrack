...
public enum AuthenticationStrings {
    ...
    public enum Errors {
        public static let serviceUnavailable = "We couldn’t complete this request. Please try again."
        ...
        public static let shortPassword =
    ...
    public enum Content {
        ...
        public static let alternative = "OR"
    }
}
